...
const Toast = memo(({ icon, title }: any) => {
  ...
  return ReactDOM.createPortal(
    <div className="flex flex-col items-center justify-end gap-2 w-96 h-20 animate-bounce text-center overflow-hidden fixed top-6 right-0 z-40 bg-primaryColor rounded-tl-md rounded-bl-md border dark:border-white border-black">
